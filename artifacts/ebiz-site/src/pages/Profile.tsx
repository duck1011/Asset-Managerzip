      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="space-y-12">
          ...
          <section className="bg-primary/5 rounded-2xl p-8 md:p-12 border border-primary/10">
            <h2 className="text-sm font-bold uppercase tracking-wider text-primary mb-4">Our Mission</h2>
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8 border-t">
            <div className="text-center p-6">
              ...
              <div className="text-sm text-muted-foreground uppercase tracking-wide font-medium">Clients Served</div>
            </div>
            <div className="text-center p-6">
              <div className="text-4xl font-bold text-primary mb-2">12</div>
              <div className="text-sm text-muted-foreground uppercase tracking-wide font-medium">Digital Specialists</div>
            </div>
            <div className="text-center p-6">
              <div className="text-4xl font-bold text-primary mb-2">2018</div>
              <div className="text-sm text-muted-foreground uppercase tracking-wide font-medium">Year Founded</div>
            </div>
          </section>
        </div>
      </div>
