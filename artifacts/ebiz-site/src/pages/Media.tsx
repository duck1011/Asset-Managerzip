    ...
    <div className="min-h-screen bg-background py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Media Studio</h1>
          <p className="text-xl text-muted-foreground">
            Explore our portfolio of recent work and creative assets.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-16">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload a new image to the portfolio.</CardDescription>
            </CardHeader>
            <CardContent>
