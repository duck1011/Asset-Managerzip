 ...
 */
export const getUserBookings = async ( options?: RequestInit): Promise<BookingsResponse> => {

  return customFetch<BookingsResponse>(getGetUserBookingsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetUserBookingsQueryOptions = <TData = Awaited<ReturnType<typeof getUserBookings>>, TError = ErrorType<ErrorEnvelope>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getUserBookings>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetUserBookingsQueryError = ErrorType<ErrorEnvelope>
...
export function useGetUserBookings<TData = Awaited<ReturnType<typeof getUserBookings>>, TError = ErrorType<ErrorEnvelope>>(
 ...
 */
export const createBooking = async (createBookingRequest: CreateBookingRequest, options?: RequestInit): Promise<BookingRecord> => {

  return customFetch<BookingRecord>(getCreateBookingUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getGetUserConsultationsUrl = () => {
...
/**
 * @summary Get consultations for the authenticated user
 */
export const getUserConsultations = async ( options?: RequestInit): Promise<ConsultationsResponse> => {

  return customFetch<ConsultationsResponse>(getGetUserConsultationsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetUserConsultationsQueryKey = () => {
    return [
    `/api/consultations`
    ] as const;
    }
...
export const getGetUserConsultationsQueryOptions = <TData = Awaited<ReturnType<typeof getUserConsultations>>, TError = ErrorType<ErrorEnvelope>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getUserConsultations>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetUserConsultationsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getUserConsultations>>> = ({ signal }) => getUserConsultations({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getUserConsultations>>, TError, TData> & { queryKey: QueryKey }
}

export type GetUserConsultationsQueryResult = NonNullable<Awaited<ReturnType<typeof getUserConsultations>>>
export type GetUserConsultationsQueryError = ErrorType<ErrorEnvelope>
...
export function useGetUserConsultations<TData = Awaited<ReturnType<typeof getUserConsultations>>, TError = ErrorType<ErrorEnvelope>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getUserConsultations>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetUserConsultationsQueryOptions(options)
 ...
 */
export const createConsultation = async (createConsultationRequest: CreateConsultationRequest, options?: RequestInit): Promise<ConsultationRecord> => {

  return customFetch<ConsultationRecord>(getCreateConsultationUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateConsultationMutationOptions = <TError = ErrorType<ErrorEnvelope>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateConsultationMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Create a new consultation request
 */
export const useCreateConsultation = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createConsultation>>, TError,{data: BodyType<CreateConsultationRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
